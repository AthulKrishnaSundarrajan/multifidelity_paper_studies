...
---------------------- INPUT FILES ---------------------------------------------
"DLC1.6_0_weis_job_3_ElastoDyn.dat" EDFile      - Name of file containing ElastoDyn input parameters (quoted string)
...
"DLC1.6_0_weis_job_3_InflowWind.dat" InflowFile  - Name of file containing inflow wind input parameters (quoted string)
"DLC1.6_0_weis_job_3_AeroDyn.dat" AeroFile    - Name of file containing aerodynamic input parameters (quoted string)
"DLC1.6_0_weis_job_3_ServoDyn.dat" ServoFile   - Name of file containing control and electrical-drive input parameters (quoted string)
"DLC1.6_0_weis_job_3_SeaState.dat" SeaStFile   - Name of file containing sea state input parameters (quoted string)
"DLC1.6_0_weis_job_3_HydroDyn.dat" HydroFile   - Name of file containing hydrodynamic input parameters (quoted string)
"none"                 SubFile     - Name of file containing sub-structural input parameters (quoted string)
"DLC1.6_0_weis_job_3_MoorDyn.dat" MooringFile - Name of file containing mooring system input parameters (quoted string)
