...
---------------------- INPUT FILES ---------------------------------------------
"DLC1.6_0_weis_job_1_ElastoDyn.dat" EDFile      - Name of file containing ElastoDyn input parameters (quoted string)
...
"DLC1.6_0_weis_job_1_InflowWind.dat" InflowFile  - Name of file containing inflow wind input parameters (quoted string)
"DLC1.6_0_weis_job_1_AeroDyn.dat" AeroFile    - Name of file containing aerodynamic input parameters (quoted string)
"DLC1.6_0_weis_job_1_ServoDyn.dat" ServoFile   - Name of file containing control and electrical-drive input parameters (quoted string)
"DLC1.6_0_weis_job_1_SeaState.dat" SeaStFile   - Name of file containing sea state input parameters (quoted string)
"DLC1.6_0_weis_job_1_HydroDyn.dat" HydroFile   - Name of file containing hydrodynamic input parameters (quoted string)
"none"                 SubFile     - Name of file containing sub-structural input parameters (quoted string)
"DLC1.6_0_weis_job_1_MoorDyn.dat" MooringFile - Name of file containing mooring system input parameters (quoted string)
...
15.0                   VTK_fps     -Frame rate for VTK output (frames per second){will use closest integer multiple of DT} [used only if WrVTK=2 or WrVTK=3]
