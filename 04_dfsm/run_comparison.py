...
if __name__ == '__main__':
    ...
    bounds = np.array([[1, 3.0],[0.1,3.0]])
    desvars = {'omega_pc':np.array([2]),'zeta_pc' : np.array([2])}
    npts = 25

    n_dims = len(desvars.keys())
    sampling_type = 'fullfact'
    ...
    if rank == 0:
        ...
        dfsm_file = this_dir + os.sep + 'dfsm_iea15_test.pkl'
    ...
    if color_i == 0:
        ...
        lf_warmstart_file = OF_dir + os.sep +'lf_ws_file_oz_36.dill'
        hf_warmstart_file = OF_dir + os.sep +'hf_ws_file_oz_36.dill'
